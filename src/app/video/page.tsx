...
export default function Video() {
  return (
    <main>
      <div className='container flex flex-col mx-auto lg:px-80'>
        <span className='uppercase text-center mt-10'>new video</span>
        <ul className='video-section w-full flex flex-wrap'>
          {MOCK_VIDEO_DATA.map((i, index) => (
            <li key={index} className='w-full md:w-1/2 p-7'>
              <a href={i.videoUrl} target='_blank'>
                ...
                <div className='text-center font-bold mt-2'>{i.title}</div>
              </a>
            </li>
          ))}
        </ul>
